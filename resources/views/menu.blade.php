...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href=" {{url('/')}} ">M SR</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href=" {{route('write_post')}} ">Create Post</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <p class="copyright text-muted">Copyright &copy; M SR Sheam || Desigbed By M SR Sheam.</p>
        </div>
      </div>
    </div>
  </footer>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
       $(".delete_categpry").click(function(){ 
